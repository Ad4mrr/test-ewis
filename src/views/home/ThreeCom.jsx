...
function ThreeCom() {
    ...
    return (
        <>
            <primitive object={fencesM.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
            <primitive object={solaM.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
            <primitive object={threVOm.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
            <primitive object={threVTwm.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
            <primitive object={threVThm.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
            <primitive object={roadDM.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />

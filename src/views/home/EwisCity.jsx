...
function EwisCity() {
    ...
    return (
        <>
                ...
                <primitive object={cityM.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
                <primitive object={bank.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
                <primitive object={CarTS.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
                <primitive object={cofeM.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
                <primitive object={communicationM.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
                <primitive object={ESolutionM.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
                <primitive object={estoreM.scene} scale={0.025} position={[0, -10, 0]} rotation={[0, 0, 0]} />
                <primitive object={hospitalM.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
                <primitive object={martM.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
                <primitive object={mamarigoM.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
                <primitive object={periperalMR.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
                <primitive object={periperalM.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
                <primitive object={policeM.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
                <primitive object={publicMoO.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
                <primitive object={schoolM.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
                <primitive object={airportM.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />
                <primitive object={topM.scene} scale={0.025} position={[0, -12.5, 0]} rotation={[0, 0, 0]} />

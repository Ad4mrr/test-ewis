            ...
            <AuthWrapper>
                ...
                <div className="w-full flex flex-col items-center bg-primarygray py-10">
                    ...
                    <div className="overflow-x-auto w-full px-20">
                        ...
                        {loading ? (
                            <p className='font-Poppins text-lg font-medium text-center py-6'>Loading News...</p>
                        ) : error ? (
                            <p>Error: {error}</p>
                        ) : news.length === 0 ? (
                            ...
                            <div className="bg-white rounded-xl overflow-hidden flex flex-col">
                                <table className="w-full">
                                    ...
                                    <tbody>
                                        {news.map(newsItem => (
                                            <tr key={newsItem._id} className="border-b border-primarysh font-Poppins text-sm text-left">
                                                <td className="px-4 py-2">
                                                    {newsItem.imageFile && (
                                                        <img
                                                            src={`http://localhost:5000/${newsItem.imageFile}`}

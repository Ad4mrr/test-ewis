        ...
        <AuthWrapper>
            ...
            <div className="w-screen flex flex-col items-center justify-start">
                <div className="container py-10">
                    <h2 className="text-center font-Poppins font-semibold text-3xl my-5">Update News</h2>
                    <form onSubmit={updateNews} className="flex flex-col gap-5">
                        ...
                        <button className="bg-primary px-4 py-2 rounded-lg font-Poppins text-white w-44">Update News</button>
                    </form>
                </div>
            </div>
        </AuthWrapper>

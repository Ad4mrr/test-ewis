                    ...
                    <div className="overflow-x-auto w-full px-20">
                        ...
                        <div className="bg-white rounded-xl overflow-hidden flex flex-col">
                            <table className="w-full">
                                ...
                                <tbody>
                                    {jobs.map((job) => (
                                        <tr key={job._id} className="border-b border-primarysh font-Poppins text-sm text-left">
                            ...
                            {editingJob && (
                                <div className="mt-10 py-10 bg-white rounded-2xl p-5">
                                    ...
                                    <form onSubmit={handleUpdateJob} className="flex flex-col gap-5">
                                        <input
                                            type="text"
                                            value={jobTitle}
                                        ...
                                        <input
                                            ...
                                            required
                                        />
                                        <button type="submit" className="bg-primary px-4 py-2 rounded-lg font-Poppins text-white w-44">
                                            Update Job
                                        </button>
                                    </form>
                                </div>

    ...
    <AuthWrapper>
      ...
      <div className='w-screen flex flex-col items-center justify-start'>
        <div className='container py-10 '>
          <h2 className='text-center font-Poppins font-semibold text-3xl my-5'>Update your post here</h2>
          <form onSubmit={updatePost} className='flex flex-col gap-5'>
            ...
            <p className='font-Poppins text-base text-red italic'>NOTE: Please select existing image or new image</p>
            <input
              type="file"
            ...
            <button className='bg-primary px-4 py-2 rounded-lg font-Poppins text-white w-44'>Update Post</button>
          </form>
        </div>
      </div>
    </AuthWrapper>

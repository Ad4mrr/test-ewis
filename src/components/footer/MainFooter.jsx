    ...
    return (
        <>
            <footer className="bg-blackFooter z-20 py-14 flex flex-col gap-5 bg-fixed">
                <div className=" mx-auto w-full max-w-screen-xl flex flex-col lg:flex-row gap-10 px-5 overflow-hidden">
                    <div className='basis-1/4 flex flex-col w-full gap-5'>
                        ...
                        <div className='flex flex-row gap-5'>
                            <a href="/" target="_blank" rel="noopener noreferrer" className='w-10 h-10  lg:w-16 lg:h-16  rounded-full transition-transform  hover:translate-y-2 duration-700 ease-in-out '>
                        ...
                        <div className='flex flex-col lg:flex-row gap-5  w-full '>
                            <div className='basis-1/3 flex flex-col gap-5'>
                                ...
                                <div className='flex flex-col gap-2'>
                                    ...
                                    />
                                    <FooterLink
                                        pageTitle='EWIS Peripherals'
                                        to='/peripheral'
                                    />
                                    <FooterLink
                                        pageTitle='Topan Forms'
                                        to='/top-an-forms'
                                    />
                        ...
                        <div className='flex flex-row gap-5 border-y-[1px] border-primarysh w-full'>
                            <div className="w-full py-5">
                                <Carousel
                                    ...
                                    className=''
                                >
                                    <img src="https://i.imgur.com/62Qdp7J.png" alt="..." className='w-26 h-14 lg:w-52 lg:h-28' />
                                    <img src="https://i.imgur.com/LT3VFgJ.png" alt="..." className='w-26 h-14 lg:w-52 lg:h-28' />
                                    <img src="https://i.imgur.com/OYnl91J.png" alt="..." className='w-26 h-14 lg:w-52 lg:h-28' />
                                    <img src="https://i.imgur.com/JTgvEhi.png" alt="..." className='w-26 h-14 lg:w-52 lg:h-28' />
                                    <img src="https://i.imgur.com/nEBbHCM.png" alt="..." className='w-26 h-14 lg:w-52 lg:h-28' />
                                </Carousel>
                            </div>
                        </div>
                        <div className='flex flex-col lg:flex-row gap-5  w-full '>
                    ...
                    <div>
                        <div>
                            <p className='text-white text-sm font-Rubik flex flex-row flex-wrap gap-4'>
                                Copyright © 2024 E-Wis Solutions, All rights reserved. Powered by
                                <a
                                    className='text-white text-sm transition-colors hover:text-primary duration-500 ease-in-out hover:underline'
                                    href="https://artslabcreatives.com/index.html" target="_blank" rel="noopener noreferrer"> Artslab Creatives</a>.
                            </p>
                        </div>
                    </div>
                    <div>
                        <div className='flex flex-row items-start justify-start gap-4'>
                            ...
                            <a href="http://" target="_blank" rel="noopener noreferrer " className='text-white text-sm transition-colors hover:text-primary duration-500 ease-in-out flex flex-row gap-2'>

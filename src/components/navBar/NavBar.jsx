...
function NavBar() {
  ...
  return (
    <>
      <header className="sticky top-0 bg-primary z-50 transition duration-1000 ease-in-out">
        <nav
          className="mx-auto flex max-w-screen-xl items-center justify-between py-4 px-8 z-50"
          aria-label="Global"
        >
